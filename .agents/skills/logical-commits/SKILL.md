...
description: >
  ...
  tests-after already landed in the TDD slice, when a review-thread or
  CI-fix commit would land on HEAD, or when a dedicated test or
  Playwright flow would land after its production in that slice.
---
